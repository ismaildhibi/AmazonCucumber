...
public class UserPage {
	...
	WebElement Btnsave;
	@FindBy(xpath = "//*[@id=\"mat-dialog-0\"]/tb-add-new-user-dialog/form/div[2]/tb-users/div/form/div/fieldset[2]/div/mat-selection-list/mat-list-option/div")
	WebElement elments1;
	...
	@FindBy(xpath="/html/body/tb-root/tb-home/mat-sidenav-container/mat-sidenav-content/div/div/tb-ag-grid-entity/mat-drawer-container/mat-drawer-content/div/div/ag-grid-angular/div/div[6]/div/div[1]/span[2]/span")
	...
	@FindBy(xpath="//button[contains(@class,'mat-focus-indicator mat-button mat-button-base mat-primary')][2]")
	...
	public void clicktofiltre() {
		...
		actions.moveToElement(filtreEmail);
	...
	public void setonfiltre(String FirstName) {
		...
		Inputsearch.sendKeys(FirstName);	
	}
