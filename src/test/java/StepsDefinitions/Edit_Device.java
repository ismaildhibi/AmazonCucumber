...
public class Edit_Device extends Base {
    ...
    public void the_user_edit_divice_type_label_description_and_click_to_save() throws InterruptedException {
    	  device = new DevicePage(driver);
    	device.ClickToEditDevice();
    	device.ClickToSecondEditDevice();
    	Thread.sleep(1000);
    	device.Closepoopup();
